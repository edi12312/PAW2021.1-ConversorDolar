...
import br.com.unipe.aula.model.Valor;
...
public class WelcomeController {
	...
	public ModelAndView exibeReal(@ModelAttribute Valor valor) {
		ModelAndView view = new ModelAndView("formulario");
		
		view.addObject("mensagem", "Este valor corresponde a:R$ " + (valor.getDolar())*5.52  + " reais");
